...
# 导出阴影
def get_shadow_soft_mask_img(input_img, index, output_path, filename="shadow_soft_mask"):
    """
    From pure shadow image, get its soft mask with lime color.
    ...
    :return: PIL.Image: the shadow soft mask
    """
